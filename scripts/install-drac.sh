...
# Central pública da infraestrutura atual. Instalações existentes podem manter
# sua URL registrada; novas instalações não devem nascer apontando para o
# domínio temporário anterior.
